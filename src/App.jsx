          ...
          <table style={{width:"100%",borderCollapse:"collapse",fontSize:12,tableLayout:"fixed"}}>
            ...
            <tbody>{compList.slice(0,predListShow).map(p=>{
              ...
              return<tr key={p.id} style={{borderBottom:"1px solid "+C.bdr,opacity:isAnomaly||isYuchal?0.5:1}}>
                ...
                <td style={{padding:"6px",textAlign:"right",color:"#a8b4ff",fontFamily:"monospace",fontSize:11}}>{isYuchal?<span style={{color:"#e24b4a",fontSize:10}}>유찰</span>:p.actual_adj_rate!=null?(100+Number(p.actual_adj_rate)).toFixed(4)+"%":""}</td>
